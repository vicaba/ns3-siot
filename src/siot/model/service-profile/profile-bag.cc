...
void ProfileBag::AddProfile(const std::string, const ServiceProfile)
{

}

std::experimental::fundamentals_v1::optional<ServiceProfile> ProfileBag::Search(const std::string category, const std::string identifier) const
{
